...
const samStore = create((set) => ({
    ...
    fetchContracts: async () => {
        ...
        try {
            ...
            const response = await axios.get("https://api.sam.gov/prod/opportunities/v2/search?limit=1000&api_key=1FgZGo0A8oeOC7vbpe5U52aftLoWHgCkN2ubETP3&postedFrom=01/01/2023&postedTo=12/01/2023&setAside=VSA&state=mo");
